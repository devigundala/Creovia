...
const BlogTitles = () => {
  ...
  return (
    <div className='h-full overflow-y-scroll p-6 items-start flex flex-wrap gap-4
    text-slate-700'>
      {/* left col*/}
      <form onSubmit={onSubmitHandler} className='w-full max-w-md p-4 bg-white rounded-lg border
      border-gray-200'>
      ...
      {/* right col*/}
      <div className='w-full max-w-md p-4 bg-white rounded-lg flex flex-col border
